package com.devscribed.flutter_social_share;
...
import com.devscribed.flutter_social_share.utils.SocialShareUtil;
...
public class FlutterSocialSharePlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_social_share");
