```flutter_social_share``` supports sharing files to social media (Facebook, Instagram, Instagram Story, Messenger, Telegram, WhatsApp, Twitter, Tiktok, SMS, System, etc.). If you want to share text, file, image, text with image or text with files then this plugin is all you need.
...
**Simply use FlutterSocialShare class and call the method of which platform you want to share.
...
***Open Xcode and change your deployment target to iOS 13 or higher***
...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  override func application(
    ...
    didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?
      ...
      let tiktok_channel = FlutterMethodChannel(name: "flutter_social_share_tiktok", binaryMessenger: cntrl.binaryMessenger)
...
class _MyAppState extends State<MyApp> {
  FlutterSocialShare flutterSocialShare = FlutterSocialShare();
  ...
  shareToWhatsApp(String message, String filePath) async {
    await flutterSocialShare.android.shareToSMS(message, filePath);
  }
}
